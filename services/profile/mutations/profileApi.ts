...
import type { ProfileData, ProfileFormState, ProfilePasswordFormState } from '@/types/profile';
...
export async function fetchCurrentProfile(supabase: SupabaseClient): Promise<ProfileData> {
  const {
    data: { user },
