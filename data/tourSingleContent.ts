...
const includedItemsBase: IncludedExcludedItem[] = [
...
const itineraryStepsBase: ItineraryStep[] = [
  {
    id: 1,
    icon: 'icon-pin',
    title: 'Day 1: Airport Pick-Up and Hotel Check-In',
