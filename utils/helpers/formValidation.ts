...
import type { ProfileFormState, ProfilePasswordFormState } from '@/types/profile';
...
export function validateProfileForm(input: ProfileFormState): ValidationErrors<ProfileFormState> {
...
export function validatePasswordForm(
  input: ProfilePasswordFormState,
): ValidationErrors<ProfilePasswordFormState> {
  const errors: ValidationErrors<ProfilePasswordFormState> = {};
