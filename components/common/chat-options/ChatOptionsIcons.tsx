...
import type { ChatOptionId } from '@/content/shared/chatOptions';

interface ChatOptionIconProps {
  channelId: ChatOptionId;
}
...
export function ChatOptionIcon({ channelId }: ChatOptionIconProps) {
...
export function ChatOptionsClosedIcon(): ReactNode {
  return <i className='icon-headphone text-24' aria-hidden='true'></i>;
}

export function ChatOptionsOpenIcon() {
  return (
