...
export default function FirstVisitPromoModal() {
  ...
  return (
    <div className='promoModal' onClick={(event) => event.target === event.currentTarget && closePromo()}>
      <div
      ...
      >
        ...
        <div className='promoModal__actions'>
          <Link href='/tours' className='button -md -dark-1 bg-accent-1 text-white' onClick={closePromo}>
            Explore Tours
          </Link>
          <button type='button' className='button -md -outline-accent-1 text-accent-1' onClick={closePromo}>
            Maybe Later
          </button>
        </div>
      </div>
