...
import FooterLinks from '@/components/layout/shared/FooterLinks';
import Socials from '@/components/layout/shared/Socials';
import { footerContent } from '@/content/shared/layoutFooter';

export default function SiteFooter() {
  const footerNewsletterEmailId = useId();
  const { contact, copyright, newsletter, social, support } = footerContent;
            ...
            <div className='justify-between y-gap-20 row'>
                ...
                <div className='items-center y-gap-20 row'>
                  ...
                  <div className='col-auto'>
                    <div className='text-20 fw-500'>
                      {support.prefix} &nbsp;
                      <span className='text-accent-1'>{support.phoneDisplay}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='col-auto'>
                <div className='footerSocials'>
                  <div className='footerSocials__title'>{social.title}</div>
          ...
          <div className='footer__content'>
            <div className='justify-between y-gap-40 row'>
              <div className='col-lg-4 col-md-6'>
                <h3 className='text-20 fw-500'>{contact.title}</h3>

                <div className='y-gap-10 mt-20'>
                  <a className='d-block' href={contact.address.href}>
                    {contact.address.text}
                  </a>
                  <a className='d-flex items-center' href={contact.phone.href}>
                    <svg
                      width='14'
                      height='14'
                      viewBox='0 0 24 24'
                  ...
                  <a
                    ...
                    aria-label={contact.viber.ariaLabel}
                  >
                    <svg
                      width='14'
                      height='14'
              ...
              <div className='col-lg-3 col-md-6'>
                <h3 className='text-20 fw-500'>{newsletter.title}</h3>
                <p className='mt-20'>{newsletter.description}</p>
                ...
                <div className='footer__newsletter'>
                  ...
                  />
                  <button>{newsletter.submitLabel}</button>
                </div>
              </div>
            </div>
          </div>
